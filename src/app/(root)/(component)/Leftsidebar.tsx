            ...
            {sidebarLinks.map((link) => {
              ...
              return (
                <li 
                  ...
                  className={`rounded-lg cursor-pointer base-medium hover:bg-[#F6F6F6] hover:border hover:border-[#E2E2E2] transition group ${isActive && 'bg-[#F6F6F6] border border-[#E2E2E2]'}`} 
                  key={link.label}
                >
                  <Link href={link.route} className='flex gap-4 items-center p-[0.85rem]'>
